...
Future<void> testTimetableData() async {
  ...
  try {
    ...
    for (var timetable in timetables) {
      ...
      print(
        '     Semester: ${timetable['semester']}, Course: ${timetable['course_code']}, Batch: ${timetable['batch']}',
      );
    }
    ...
    for (var period in periods) {
      print(
        '   - Day: ${period['day']}, Time: ${period['start_time']}-${period['end_time']}',
      );
      print(
        '     Subject: ${period['subject_name']} (${period['subject_code']})',
      );
    }
    ...
    if (specificTimetable.isEmpty) {
      ...
      print(
        '   📅 Found ${periodsForTimetable.length} periods for this timetable',
      );
    }
  } catch (error) {
